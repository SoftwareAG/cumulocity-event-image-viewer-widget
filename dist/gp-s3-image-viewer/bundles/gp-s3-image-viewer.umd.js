(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('aws-sdk'), require('@c8y/client'), require('@angular/platform-browser'), require('@c8y/ngx-components'), require('@angular/core'), require('@angular/material'), require('@angular/material/form-field'), require('@angular/platform-browser/animations'), require('@angular/material/icon'), require('@angular/common/http'), require('ngx-bootstrap/carousel')) :
    typeof define === 'function' && define.amd ? define('gp-s3-image-viewer', ['exports', 'rxjs', 'aws-sdk', '@c8y/client', '@angular/platform-browser', '@c8y/ngx-components', '@angular/core', '@angular/material', '@angular/material/form-field', '@angular/platform-browser/animations', '@angular/material/icon', '@angular/common/http', 'ngx-bootstrap/carousel'], factory) :
    (factory((global['gp-s3-image-viewer'] = {}),global.rxjs,global.AWS,global.client,global.ng.platformBrowser,global.ngxComponents,global.ng.core,global.ng.material,global.ng.material['form-field'],global.ng.platformBrowser.animations,global.ng.material.icon,global.ng.common.http,global.carousel));
}(this, (function (exports,rxjs,AWS,client,platformBrowser,ngxComponents,core,material,formField,animations,icon,http,carousel) { 'use strict';
